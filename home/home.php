            ...
            <section class="hero text-center text-light">
                ...
                <div class="container-sm">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">CryptoShow</h1>
	                        <p class="hero-paragraph">Our Event Management system offers different variety of Events, come and have a look.</p>
	                        <div class="hero-cta">
								<a class="button button-primary button-wide-mobile" href="../Events/Event.php">Get Started</a>
							</div>
						</div>
			...
			<div class="site-footer-bottom">
				<div class="container">
					<div class="site-footer-inner">
						...
						<div class="footer-copyright">&copy; 2024 CryptoShow, all rights reserved</div>
					</div>
				</div>
			</div>
        </footer>
