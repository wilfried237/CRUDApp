        ...
        <div class="gap-y-4 p-4 w-100">
            <div class="d-flex align-items-center">
                <div class="d-flex flex-column">
                    <p class="fs-2 fw-bold p-0 m-0">Registered Events</p>
            ...
            <div class="row row-cols-2 row-cols-lg-4 g-2 g-lg-3 g-2 g-lg-3">
                <?php
                    ...
                    $sql = "SELECT Event.*,Registered_User.*, Event_Device.fk_event_id 
                    FROM Event_Device 
                    JOIN Event ON Event.event_id = Event_Device.fk_event_id
                    JOIN Registered_User ON Registered_User.user_id = Event_Device.fk_user_id
                    WHERE Event_Device.fk_user_id = '$userID';
                    ";
                ...
                if ($result->fetchArray(SQLITE3_ASSOC)) {
                    ...
                    echo '<p class="mt-5 text-center w-100 fs-4 text-secondary">No events found.</p>';
                }
                ?>
            </div>
        </div>
